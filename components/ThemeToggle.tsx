...
const THEME_CHANGE_EVENT = 'garu:theme-change';
...
export default function ThemeToggle() {
  const dark = useSyncExternalStore(subscribeThemeChange, getThemeSnapshot, () => false);
  ...
  return (
    <button
      onClick={toggle}
      className="focus-ring relative h-9 w-9 rounded-xl border border-border bg-surface hover:bg-surface-hover transition-all duration-300 flex items-center justify-center"
